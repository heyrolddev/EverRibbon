...
export function SignOutButton({
  ...
  const triggerClass =
    variant === "rail"
      ? "flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-bold text-paper-100/70 transition-colors hover:bg-brand-700/20 hover:text-paper-50"
      : variant === "block"
        ? "rounded-full bg-ink-950/5 px-5 py-2.5 text-sm font-bold text-ink-900 ring-1 ring-ink-950/10 transition-colors hover:bg-brand-700 hover:text-paper-50"
    ...
    <>
      ...
      {asking && (
        ...
        >
          ...
          />
          <div className="relative w-full max-w-sm rounded-3xl bg-paper-50 p-6 shadow-2xl ring-1 ring-ink-950/10">
            <p
              id="signout-title"
            ...
            <div className="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
              <button
                ...
                disabled={signingOut}
                className="rounded-full px-5 py-3 text-sm font-bold text-ink-900/70 transition-colors hover:text-ink-950 disabled:opacity-50"
              >
                Stay signed in
              </button>
              <button
                ...
                disabled={signingOut}
                autoFocus
                className="rounded-full bg-brand-700 px-6 py-3 text-sm font-black text-paper-50 transition-transform hover:scale-[1.02] disabled:opacity-60 disabled:hover:scale-100"
              >
