    ...
    <div>
      ...
      {current ? (
        <div className="overflow-hidden rounded-2xl bg-ink-950/5 ring-1 ring-ink-950/10">
          ...
          <div className="flex flex-wrap gap-2 p-2.5">
            <button
              ...
              disabled={pending}
              className="rounded-lg bg-ink-950/5 px-3 py-2 text-xs font-bold text-ink-900/70 transition-colors hover:bg-ink-950/10 disabled:opacity-50"
            >
            ...
            <button
              ...
              onClick={clear}
              disabled={pending}
              className="rounded-lg px-3 py-2 text-xs font-bold text-brand-700 transition-colors hover:bg-brand-700 hover:text-paper-50 disabled:opacity-50"
            >
              Remove
            </button>
          </div>
        ...
        <button
          ...
          onClick={() => input.current?.click()}
          disabled={pending}
          className="w-full rounded-2xl border-2 border-dashed border-brand-300 bg-paper-100 px-4 py-6 text-sm font-semibold text-ink-900/70 transition-colors hover:border-brand-700 hover:text-ink-950 disabled:opacity-60"
        >
      ...
      {error ? (
        <p className="mt-1.5 text-xs font-semibold text-brand-800">{error}</p>
      ) : (
