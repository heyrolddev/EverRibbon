    ...
    <AnimatePresence>
      {!done && (
        ...
        >
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute h-80 w-80 rounded-full bg-brand-700/30 blur-3xl"
          />
          ...
          <div className="mt-8 h-0.5 w-40 overflow-hidden rounded-full bg-paper-100/15">
            <div className="intro-bar h-full w-0 bg-gradient-to-r from-brand-700 via-warn-500 to-accent-200" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
