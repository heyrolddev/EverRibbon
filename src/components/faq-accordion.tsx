        ...
        return (
          <div
            ...
            className={`overflow-hidden rounded-2xl border-2 transition-colors ${
              open ? "border-brand-700 bg-paper-100" : "border-ink-950/10 bg-paper-100/60"
            }`}
          >
            <button
            ...
            >
              ...
              <motion.span
                ...
                className={`grid h-7 w-7 shrink-0 place-items-center rounded-full text-lg leading-none ${
                  open ? "bg-brand-700 text-paper-50" : "bg-ink-950/10 text-ink-900"
                }`}
              >
                +
              </motion.span>
            ...
            <AnimatePresence initial={false}>
              {open && (
                ...
                >
                  <p className="px-6 pb-5 text-ink-900/80">{item.answer}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
