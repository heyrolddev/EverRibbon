      ...
      <div className="-mx-2.5">
        ...
        >
          {reviews.map((r) => (
            ...
            >
              <figure className="flex h-full flex-col gap-3 rounded-3xl bg-paper-50/10 p-6 ring-1 ring-paper-50/20">
                <Stars rating={r.rating} className="text-accent-300" />
                ...
                <figcaption className="flex items-center gap-3">
                  ...
                  <span className="min-w-0 text-sm text-paper-100/70">
                    <span className="block truncate font-bold text-paper-50">
                      {r.author}
                    </span>
            ...
            >
              <span
                className={`block rounded-full transition-all ${
                  i === safePage
                    ? "h-2.5 w-7 bg-accent-200"
                    : "h-2.5 w-2.5 bg-paper-50/35 hover:bg-paper-50/60"
                }`}
              />
            </button>
          ))}
