  ...
  return (
    <div className="relative">
      ...
      {many && (
        ...
        // the fixed assistant launcher, which is exactly where a
        ...
        <div className="mt-6 flex items-center gap-5">
          ...
          <div className="hidden gap-2 sm:flex">
            ...
            <button
              ...
              aria-label="Previous"
              className="grid h-10 w-10 place-items-center rounded-full bg-ink-950 text-lg font-black text-paper-50 ring-2 ring-ink-950 transition-colors hover:bg-brand-700 hover:ring-brand-700"
            >
              ←
            </button>
            <button
