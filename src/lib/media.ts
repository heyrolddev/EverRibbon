...
/*
 * One bucket per shop, named by its config key.
 *
 * Hardcoding the name meant a second deployment wrote its photos into the
 * first shop's bucket — which looks like nothing at all until two businesses
