...
const TABLES = [
  ...
  "product_materials",
  "product_components",
  // What a product needs to travel, and what an order needs once. Same standing
  // as a recipe: entered by hand, and the reason a take-out costs more than
  // the same product eaten at the stall.
  "product_packaging",
  "order_packaging",
 ...
 * every currency symbol and every ñ in a customer's name comes out as mojibake. Sheets and
