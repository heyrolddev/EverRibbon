...
export const STATE_TONE: Record<HomeState, { label: string; chip: string }> = {
  live: { label: "On the homepage", chip: "bg-ok-600 text-paper-50" },
  listed: { label: "Not starred — in All news & promos", chip: "bg-ink-950/[0.07] text-ink-900/70" },
  strip: { label: "In the scrolling strip", chip: "bg-ink-950/[0.07] text-ink-900/70" },
  queued: { label: "Not starred", chip: "bg-ink-950/[0.07] text-ink-900/70" },
  scheduled: { label: "Scheduled", chip: "bg-brand-700 text-paper-50" },
  finished: { label: "Finished", chip: "bg-ink-950/10 text-ink-900/60" },
  off: { label: "Off", chip: "bg-ink-950/10 text-ink-900/60" },
};
