...
const FILES: BackupFile[] = [
  ...
  },
  {
    ...
    label: "What sold",
    what: "One row per product sold, with quantity and price.",
  ...
  {
    kind: "product-costs.csv",
    label: "Product costs",
    what: "Price, material cost, profit and food cost % for every product.",
    when: "Deciding what to reprice, push, or take off the menu.",
    tables: ["products", "product_materials"],
  },
  {
    kind: "inventory.csv",
    label: "Inventory",
    what: "Every material, what it costs, and how much is left.",
