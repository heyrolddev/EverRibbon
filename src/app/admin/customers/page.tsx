  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        {statsError && (
          <p className="mt-3 rounded-2xl bg-brand-50 px-5 py-3 text-sm font-semibold text-brand-800">
        ...
        {!canManage && (
          <p className="mt-3 rounded-2xl bg-accent-200 px-5 py-3 text-sm font-semibold text-ink-950">
