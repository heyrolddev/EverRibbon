    ...
    return (
      <div className="rounded-3xl bg-accent-50 p-8 ring-1 ring-accent-200/40">
        ...
        <p className="mt-2 max-w-xl text-sm text-ink-900/70">
          ...
          switch on &ldquo;Ask {brand.name}&rdquo;. Every chat a customer has with
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-ink-900/60">
          Every &ldquo;Ask {brand.name}&rdquo; conversation. The assistant answers
        ...
        <div>
          ...
          <p
            className={`font-display text-3xl font-black ${
              waiting > 0 ? "text-brand-700" : "text-ink-950"
            }`}
          >
            {waiting}
          </p>
