    ...
    return (
      <>
        ...
        <section className="mx-auto max-w-md px-6 py-14">
          <div className="rounded-3xl bg-ok-700 p-8 text-center text-paper-50">
    ...
    <>
      ...
      <section className="mx-auto max-w-md px-6 py-14">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          {alreadyRegistered && (
            <div className="rounded-2xl bg-accent-200 px-5 py-4 text-sm text-ink-950">
        ...
        <p className="mt-8 text-center text-sm text-ink-900/70">
