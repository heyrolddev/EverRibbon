...
export const metadata: Metadata = {
  ...
  description:
    `How ordering, paying, pickup, delivery and cancellations work at ${brand.name}.`,
};
  ...
  return (
    <section className="border-t border-ink-950/10 pt-8">
      <h2 className="flex items-baseline gap-3 font-display text-2xl font-black text-ink-950">
        <span className="text-base font-black text-brand-700">{n}</span>
        {title}
      </h2>
    ...
    <main className="flex-1">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 pt-8">
        ...
        <Numbered>
          ...
          <Section title="Ordering ahead">
            <p>
              ...
              materials and prep we can&apos;t sell to anyone else.
            </p>
            <p>
          ...
          <Section title="Notifications">
            <p>
              ...
              <Link href="/account" className="font-bold text-brand-700 hover:underline">
                your account
              </Link>{" "}
        ...
        <p className="mt-12 rounded-2xl bg-accent-200/15 p-5 text-sm text-ink-900/70 ring-1 ring-accent-200/40">
          ...
          or ask through{" "}
          <Link href="/menu" className="font-bold text-brand-700 hover:underline">
            the site
          </Link>
          .
        </p>
