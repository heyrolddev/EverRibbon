    ...
    (
      <div
        style={{
          ...
          padding: "80px",
          background: brand.palette['ink-950'],
          color: brand.palette['paper-50'],
          position: "relative",
        }}
      >
        ...
        <div
          style={{
            ...
            height: 460,
            borderRadius: 999,
            background: brand.palette[brand.roles.accentFill],
            opacity: 0.5,
          }}
        />
        <div
          style={{
            ...
            height: 520,
            borderRadius: 999,
            background: brand.palette['ink-800'],
            opacity: 0.28,
          }}
        />
