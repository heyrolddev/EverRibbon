      ...
      <main className="flex-1">
        ...
        <section className="mx-auto flex max-w-md flex-wrap justify-center gap-4 px-6 py-14">
          <Link
            ...
            className="rounded-full bg-brand-700 px-8 py-4 font-bold text-paper-50 transition-transform hover:scale-105"
          >
            Sign in →
          </Link>
          <Link
            href="/signup?next=/checkout"
            className="rounded-full border-2 border-ink-950 px-8 py-4 font-bold text-ink-950 transition-colors hover:bg-ink-950 hover:text-paper-50"
          >
            Create account
          </Link>
        </section>
