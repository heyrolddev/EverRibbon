    ...
    return (
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-md px-6 py-14 text-center">
          <div className="rounded-3xl bg-ok-700 p-8 text-paper-50">
            <p className="font-display text-2xl font-bold">You&apos;re signed in ✓</p>
            <p className="mt-2 text-paper-100/80">
              Your new password is saved — you can use it next time.
            </p>
          </div>
          <Link
            href="/"
            className="mt-6 inline-block rounded-full bg-brand-700 px-8 py-4 font-bold text-paper-50 transition-transform hover:scale-105"
          >
            Go to the site →
          </Link>
        </section>
  ...
  return (
    <main className="flex-1">
      ...
      <section className="mx-auto max-w-md px-6 py-14">
        {ready === false && (
          <div className="mb-6 rounded-2xl bg-accent-200 px-5 py-4 text-sm text-ink-950">
